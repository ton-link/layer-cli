...
export class JettonWallet implements Contract {
    ...
    async sendCreateValidator(
        ...
        jetton_amount: bigint,
        to: Address,
        val_info_link: string,
        percent: number
    ) {
        let body = beginCell()
            .storeUint(0xf8a7ea5, 32)
            .storeUint(210, 64) // op, queryId
            .storeCoins(jetton_amount)
            .storeAddress(to)
            .storeAddress(null)
            ...
            .storeRef(beginCell().storeStringTail(val_info_link).endCell())
            .endCell();
        await provider.internal(via, {
            sendMode: SendMode.PAY_GAS_SEPARATELY,
            body: body,
    ...
    async sendSubscribeService(
        ...
        let body = beginCell()
            .storeUint(0xf8a7ea5, 32)
            .storeUint(220, 64) // op, queryId
            .storeCoins(jetton_amount)
            .storeAddress(to)
            .storeAddress(null)
            .storeMaybeRef(beginCell().endCell())
            .storeCoins(toNano('0.15'))
            .storeAddress(service)
            .endCell();
        await provider.internal(via, {
            sendMode: SendMode.PAY_GAS_SEPARATELY,
            body: body,
    ...
    async sendDelegateTokenAction(
        ...
        let body = beginCell()
            .storeUint(0xf8a7ea5, 32)
            .storeUint(230, 64) // op, queryId
            .storeCoins(jetton_amount)
            .storeAddress(to)
            .storeAddress(null)
            .storeMaybeRef(beginCell().endCell())
            .storeCoins(toNano('0.1'))
            .storeAddress(validator_address)
            .endCell();
        await provider.internal(via, {
            sendMode: SendMode.PAY_GAS_SEPARATELY,
            body: body,
