import { Address, beginCell, Cell, Contract, contractAddress, ContractProvider, Sender, SendMode, toNano, internal as internal_relaxed, storeMessageRelaxed, TupleBuilder } from '@ton/core';
...
export class JettonMinter implements Contract {
        ...
        */
        ...
        async getWalletAddress(provider: ContractProvider, owner: Address): Promise<Address> {
                ...
                const { stack } = await provider.get("get_wallet_address", args.build());
